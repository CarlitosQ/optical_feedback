...
# T12 = kappa / gama * np.sinh(gama * L_G)
# T21 = kappa / gama * np.sinh(gama * L_G)
...
ax1.plot(((freq - freq_center) / 1e9), (G_abs), label="$|G|$", color=color)
...
#=========================================================================
# np.savetxt('RTG_%sum_gain_%s_%smm.txt' % (L_A * 1e3, r_ext, L_P * 1e3), np.transpose(
#     [((freq_center - freq) / 1e9), G_abs, G_phi]), fmt='%1.8e', delimiter='\t')
#=========================================================================
